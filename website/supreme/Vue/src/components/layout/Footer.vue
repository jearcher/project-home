<template>
    <footer class="site-footer center-content-mobile invert-color" :class="topOuterDivider && 'has-top-divider'">
        <div class="container">
            <div class="site-footer-inner" :class="topDivider && 'has-top-divider'">
                ...
                <div class="footer-bottom space-between text-xxs invert-order-desktop">
                    <c-footer-nav />
                    <div class="footer-copyright">&copy; 2020 Supreme, all rights reserved</div>
                </div>
            </div>
        </div>
    </footer>
