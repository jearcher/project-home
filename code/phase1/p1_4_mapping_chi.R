...
# Plan: 
# Core Layers
# 	[*] Eviction risk (pre-pandemic)
# 	[*] unemployment risk
# 	[*] COVID-19 Risk
# 	[ ] Displacement typologies
# Additional Layers
# 	[ ] Typologize Change ACS Unemployment v. DEEP Maps unemployment
# 	[ ] Segregation
# 	[ ] Outline High BIPOC
# Popup
...
chi_df <- readRDS("~/data/output/chi_df.rds")
source("~/git/hprm/code/phase1/p1_2_functions.r")
chi_e_pal <- e_pal(chi_df$rr_cut)
chi_d_vli_pal <- d_pal(chi_df$di_vlinet_cut)
chi_d_li_pal <- d_pal(chi_df$di_linet_cut)
chi_d_livli_pal <- d_pal(chi_df$di_livlinet_cut)
chi_d_mid_pal <- d_pal(chi_df$di_midnet_cut)
chi_d_high_pal <- d_pal(chi_df$di_high_cut)
chi_c_pal <- c_pal(chi_df$c_cut)
chi_u_pal <- u_pal(chi_df$u_cut)
...
saveWidget(chi_map, file="~/git/hprm/maps/p1v1chi.html")
# }
#
# chi_map <- mapping(chi_df, chi_covid)
...
map %>%
  ...
  #   labelOptions = labelOptions(textsize = "12px"),
  #   fillOpacity = .5,
  #   color = ~chi_d_vli_pal(di_vlinet_cut),
  #   stroke = TRUE,
  #   weight = 1,
  #   opacity = .3,
#   highlightOptions = highlightOptions(
...
#   labelOptions = labelOptions(textsize = "12px"),
#   fillOpacity = .5,
#   color = ~chi_d_vli_pal(di_linet_cut),
#   stroke = TRUE,
#   weight = 1,
#   opacity = .3,
#   highlightOptions = highlightOptions(
